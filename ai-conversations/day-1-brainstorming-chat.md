...
>
> - Ran `git check-ignore -q -- internship-file-explorer-take-home-task.md files; if ($LASTEXITCODE -eq 0) { 'ignored' } else { 'not_ignored_or_no_match' }`
> - Ran `Get-Item -LiteralPath 'internship-file-explorer-take-home-task.md','files' | Select-Object Name, FullName, PSIsContainer`
>
> </details>
</details>
...
>
> - Ran `rg --files`
> - Ran `Get-Item -LiteralPath 'internship-file-explorer-take-home-task.md','ai-conversations/brainstorming-prompt.md' | Select-Object FullName, Length, PSIsContainer`
>
> </details>
>
...
> - Ran `Get-Content -Raw -LiteralPath 'ai-conversations/brainstorming-prompt.md'`
>
> </details>
>
...
> <details><summary>Ran 2 commands</summary>
>
> - Ran `$i=0; Get-Content -LiteralPath 'ai-conversations/brainstorming-prompt.md' | ForEach-Object { $i++; '{0,4}: {1}' -f $i, $_ }`
...
>
> - Ran `rg --files`
> - Ran `Test-Path -LiteralPath 'AGENTS.md'`
>
> </details>
>
> Plan
